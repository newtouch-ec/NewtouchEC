...
class aftersales_ctl_admin_returnproduct extends desktop_controller{
    ...
    function return_blance(){
        ...
        $point_deductible_value = app::get('b2c')->getConf('site.point_deductible_value');
        ...
        if ($b2c_order_finish->generate($sdf, $controller, $message))
        {
            ...
            if($returns[0]['amount']){
                ...
                if($money['score_g'] > 0){
                    $sdf['money'] = $sdf['money']-($money['score_g'])*$point_deductible_value;
                    $sdf['score_cost'] = ($money['score_g'])*$point_deductible_value;
                }
                ...
                if($money['score_g'] > 0){
                    $sdf['money'] = $money_useful-$profit-($money['score_g'])*$point_deductible_value;
                    $sdf['score_cost'] = ($money['score_g'])*$point_deductible_value;
                }else{
                ...
                if($money['discount_value'] > 0 && $money['score_g'] > 0){
                    $sdf['money'] = $money['payed']+($money['discount_value'])-$profit-($money['score_g'])*$point_deductible_value;
                    $sdf['score_cost'] = ($money['score_g'])*$point_deductible_value;
                }elseif($money['discount_value'] > 0 && $money['score_g'] == 0){
                    $sdf['money'] = $money['payed']+($money['discount_value'])-$profit;
                }elseif($money['discount_value'] == 0 && $money['score_g'] > 0){
                    $sdf['money'] = $money['payed']-$profit-($money['score_g'])*$point_deductible_value;
                    $sdf['score_cost'] = ($money['score_g'])*$point_deductible_value;
                }else{
                    $sdf['money'] = $money['payed']-$profit; 
                }
