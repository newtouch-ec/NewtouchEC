...
class aftersales_ctl_site_member extends b2c_ctl_site_member
{
	...
	public function return_list($nPage=1)
    {
        ...
        $GLOBALS['runtime']['path'] = $this->path;
        $clos = "return_id,order_id,add_time,status,member_id,refund_type,is_intervene,is_safeguard";
        $filter = array();
	...
	public function return_save()
    {
        ...
        if($pmt_order['status'] == 'finish'){
            ...
            $cur_money = $model_refunds->dump(array('refund_id'=>$blances['bill_id']),'cur_money,profit');
