...
class b2c_ctl_site_gallery extends b2c_frontpage{
    ...
    public function index($cat_id='',$urlFilter=null,$orderBy=0,$tab=null,$page=1,$cat_type=null,$view,$st='g') {
       $spec_default_pic = $this->app->getConf('spec.default.pic');
       $this->pagedata['spec_default_pic'] = base_storager::image_path($spec_default_pic,'s');
...
//echo '</pre>';
    ...
    */
    ...
    public function getGoodsCol(){
        ...
        $col[]='sdb_b2c_goods.last_modify';//按照发布时间排序,需要查出此字段 by 尹鼎盛
