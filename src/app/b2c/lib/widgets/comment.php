...
class b2c_widgets_comment extends b2c_widgets_public {
     ...
     */
    public function getTopComment($number, $platformapp = 'b2c'){
        ...
        foreach ((array)$_data as $row){
            ...
            $row['_goodsLink_'] = $this->get_link(array('app'=>$platformapp,'ctl'=>'site_product','act'=>'index','args'=>array($row['type_id'])),$platformapp);
