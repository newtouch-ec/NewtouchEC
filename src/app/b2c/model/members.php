...
//                    }
        ...
        if($data['reg_type'] == 'mobile'){
            if(trim($data['contact']['phone']['mobile']) == ''){
                ...
                if(!preg_match('/^13[0-9]{1}[0-9]{8}$|170[0-9]{8}$|15[0-9]{1}[0-9]{8}$|18[0-9]{1}[0-9]{8}|14[0-9]{1}[0-9]{8}$/', trim($data['contact']['phone']['mobile']))){
...
//                    }
    ...
    function check_mobile($mobile, &$message, $member_id=null){
        ...
        if(empty($mobile)){
            ...
            return false;
        }elseif(!preg_match("/^13[0-9]{1}[0-9]{8}$|170[0-9]{8}$|15[0-9]{1}[0-9]{8}$|18[0-9]{1}[0-9]{8}|14[0-9]{1}[0-9]{8}$/", $mobile)){
