...
class wsdl extends nusoap_base {
    ...
    */
    function webDescription(){
		...
		<style type="text/css">
		    body    { font-family: arial; color: #2f302a; background-color: #ffffff; margin: 0px 0px 0px 0px; }
		    p       { font-family: arial; color: #2f302a; margin-top: 0px; margin-bottom: 12px; }
		    pre { background-color: silver; padding: 5px; font-family: Courier New; font-size: x-small; color: #2f302a;}
		    ul      { margin-top: 10px; margin-left: 20px; }
		    li      { list-style-type: none; margin-top: 10px; color: #2f302a; }
		    .content{
			margin-left: 0px; padding-bottom: 2em; }
		    .nav {
			padding-top: 10px; padding-bottom: 10px; padding-left: 15px; font-size: .70em;
			margin-top: 10px; margin-left: 0px; color: #2f302a;
