(function(){
    var ModeDialog=this.ModeDialog=new Class({
        ...
        initialize:function(url,options){
            ...
            options.top=(wsize.y-options.height)/2;
            options.left=(wsize.x-options.width)/2;

            var config="modal=true,width={width}px,height={height}px,top={top},left={left},resizable={resizable},status=no;";
