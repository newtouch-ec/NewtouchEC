<?php
  ...
  class cellphone_ctl_admin_banner extends desktop_controller{
			...
			'actions' =>array(
                  ...
                  array('label' => app::get('b2c')->_('批量操作'),
                        ...
                        'group' => array(
                            ...
                            array('label' => app :: get('b2c') -> _('排序'), 'icon' => 'download.gif', 'submit' => 'index.php?app=cellphone&ctl=admin_banner&act=singleBatchEdit&p[0]=dorder', 'target' => 'dialog'),
					                    ),
                        ),

                  ),
		    	'title'=>app :: get('b2c') -> _('轮播列表'),    
	 ...
	 function changeActivity(){
		...
		if($select_activity=="auction"){
		 echo $render -> fetch('admin/banner/auction.html');
		}
