...
class cellphone_base_member_favorite extends cellphone_cellphone{
    ...
    public function store(){
        ...
        $aData = kernel::single('business_member_storefav')->get_favorite($member_id,$member['member_lv'],$nPage,$pagelimit);
    ...
    public function goods(){
        ...
        $aData = kernel::single('b2c_member_fav')->get_favorite($member_id,
                                        $member['member_lv'],$nPage,$pagelimit);
        ...
        $this->send(true,$return, app::get('b2c')->_('收藏的商品'));
    }
