...
class cellphone_finder_activity{
    var $column_start_time = '开始时间1';
    var $column_end_time = '结束时间';
    var $detail_basic = '基本信息';
    var $column_control = '操作';

    function __construct($app){
    	$this->column_start_time = app::get('b2c')->_('开始时间');
    	$this->column_end_time = app::get('b2c')->_('结束时间');
    	$this->detail_basic = app::get('b2c')->_('基本信息');
    	$this->column_control = app::get('b2c')->_('操作');
        $this->app = $app;
        $this->app_list = array();
    }
