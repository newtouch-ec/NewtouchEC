 ...
 */
final class cellphone_payment_plugin_offline extends ectools_payment_app implements
    ectools_interface_payment_app
{
    /**
     * @var string 支付方式名称
     */
    public $name = '线下支付-客户端版';
    /**
     * @var string 支付方式接口名称
     */
    public $app_name = '线下支付接口-客户端版';
    /**
     * @var string 支付方式key
     */
    ...
    {
        return array(
            'pay_name' => array('title' => app::get('ectools')->_('支付方式名称'), 'type' =>
                    'string'),
            'support_cur' => array(
            ...
            'status' => array(
                ...
                'type' => 'radio',
                'options' => array('false' => app::get('ectools')->_('否'), 'true' => app::get('ectools')->
                        _('是')),
                'name' => 'status',
                ),
            );
