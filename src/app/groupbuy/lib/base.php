...
class groupbuy_base
{
    ...
    public function getInfo($cols='*', $filter=array(), $offset=0, $limit=-1, $orderType=null){
         $sql = "select gd.name as g_name,gd.image_default_id as g_image,c.cat_name,a.start_time,a.end_time,g.id,g.gid,g.cat_id,g.aid,g.last_price,g.nums,g.remainnums,g.personlimit,gd.price as g_price,g.image_codeid from sdb_groupbuy_groupapply as g".
        ...
        " where g.status='2' and a.act_open='true' and gd.marketable='true' ";
