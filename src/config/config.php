...
define('DB_PASSWORD', '551410aabf'); # 数据库密码
define('DB_NAME', 'bbc');    # 数据库名
...
#crontab执行定时任务 配置
#define('SYSTEM_CRONTAB',true);#开启时必须同时开启BASE_URL
#base_url 配置
#define('BASE_URL','http://localhost/bbcsource');
