		...
		*/
        ...
        foreach($senders as $sender){
			...
			if($sender){
				...
				}elseif(isset($data['sendemailcodetype']) && ($data['sendemailcodetype'] == 'userRegister')){
					$target = $data['email'];
				}else{
    ...
    function actions(){
        $actions = array(
           ...
           'account-verifyEmail'=>array('label'=>app::get('b2c')->_('会员邮箱验证'),'level'=>9,'varmap'=>app::get('b2c')->_('用户名').'&nbsp;<{$uname}>&nbsp;&nbsp;&nbsp;&nbsp;'.app::get('b2c')->_('链接').'&nbsp;<{$url}>&nbsp;&nbsp;&nbsp;&nbsp;','isIndex'=>0
            ...
            /*卖家提醒短信模板 begin zm*/
            'orders-createbussiness'=>array('label'=>app::get('b2c')->_('订单创建卖家提醒'),'level'=>9,'varmap'=>app::get('b2c')->_('订单号').'&nbsp;<{$order_id}>&nbsp;&nbsp;&nbsp;&nbsp;'.app::get('b2c')->_('总价').'&nbsp;<{$total_amount}>&nbsp;&nbsp;&nbsp;&nbsp;'.app::get('b2c')->_('配送方式').'&nbsp;<{$shipping_id}><br>'.app::get('b2c')->_('收货人手机').'&nbsp;<{$ship_mobile}>&nbsp;&nbsp;&nbsp;&nbsp;'.app::get('b2c')->_('收货人电话').'&nbsp;<{$ship_tel}>&nbsp;&nbsp;&nbsp;&nbsp;'.app::get('b2c')->_('收货人地址').'&nbsp;<{$ship_addr}><Br>'.app::get('b2c')->_('收货人').'Email&nbsp;<{$ship_email}>&nbsp;&nbsp;&nbsp;&nbsp;'.app::get('b2c')->_('收货人邮编').'&nbsp;<{$ship_zip}>&nbsp;&nbsp;&nbsp;&nbsp;'.app::get('b2c')->_('收货人姓名').'&nbsp;<{$ship_name}>','isIndex'=>1//前后台控制发送的表示0为后台1为前台
            ),
                /*卖家提醒短信模板 end zm*/
            ...
            /*卖家订单支付提醒短信模板 end zm*/
            'orders-payedbusiness'=>array('label'=>app::get('b2c')->_('订单付款时卖家提醒'),'level'=>9,'varmap'=>app::get('b2c')->_('订单号').'&nbsp;<{$order_id}>&nbsp;&nbsp;&nbsp;&nbsp;'.app::get('b2c')->_('付款人').'&nbsp;<{$pay_account}>&nbsp;&nbsp;&nbsp;&nbsp;'.app::get('b2c')->_('付款时间').'&nbsp;<{$pay_time}>&nbsp;&nbsp;&nbsp;&nbsp;'.app::get('b2c')->_('付款金额').'&nbsp;<{$money}>','isIndex'=>1//前后台控制发送的表示0为后台1为前台
            ),
           /*卖家订单支付提醒短信模板 end zm*/
