...
'goods.max_buy_num_per_order_switch'=>array('type'=>SET_T_BOOL,'default'=>'false','desc'=>app::get('b2c')->_('是否开启商品限购量')),
...
'site.watermark.wm_small_font_color'=>array('type'=>SET_T_STR,'default'=>'#2f302a','desc'=>''),
...
'site.watermark.wm_big_font_color'=>array('type'=>SET_T_STR,'default'=>'#2f302a','desc'=>''),
...
'system.money.separator'=>array('type'=>SET_T_STR,'default'=>'','desc'=>app::get('b2c')->_('金额显示千分位符号'),'helpinfo'=>'<span class=\'notice-inline\'>'.app::get('b2c')->_('设置为空代表不显示千分位符号').'</span>'),
...
//add by Seven BBC150601001 添加店铺每订单默认金额上限 start
'shops.max_money_per_order'=>array('type'=>SET_T_INT,'default'=>0,'desc'=>app::get('b2c')->_('店铺每订单默认金额上限')),
//add by Seven BBC150601001 添加店铺每订单默认金额上限 end
...
'system.shopname'=>array('type'=>SET_T_STR,'default'=>app::get('b2c')->_('点此设置您商城的名称'),'desc'=>app::get('b2c')->_('商城名称')),
...
'gallery.default_view'=>array('type'=>SET_T_ENUM,'default'=>'grid','options'=>array('index'=>app::get('b2c')->_('店铺形式'),'grid'=>app::get('b2c')->_('大图形式'),'sgrid'=>app::get('b2c')->_('小图形式')),'desc'=>app::get('b2c')->_('商品列表默认展示方式')),
...
'store.site_owner'=>array('type'=>SET_T_STR,'default'=>'','desc'=>app::get('b2c')->_('商城所有人')),
'store.contact'=>array('type'=>SET_T_STR,'default'=>'','desc'=>app::get('b2c')->_('联系人')),
