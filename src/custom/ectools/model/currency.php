...
class ectools_mdl_currency extends dbeav_model {
    ...
    */
    ...
    public function changer_odr($money, $currency='', $is_sign=false, $is_rate=false, $decimals='2', $operation_carryset='0',$separator='')
	//mod by Seven for BBC150630001-货币千分位符号 start
    {
		// 异常处理
        if ($money === null)
        ...
        if ($separator)
        {
            $cur_money = number_format($cur_money,$decimals,'.',$separator);
        }
