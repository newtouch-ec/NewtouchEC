<?php exit(); ?>a:3:{s:5:"value";s:21783:"<?php $this->__view_helper_model['base_view_helper'] = kernel::single('base_view_helper'); ?>﻿<style>
  .ad_ul .add-title,
  .ad_ul .add-url,
...
<div class="tableform widgetconfig">
    ...
    <div class="division">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <th colspan="4" style="text-align:left;background:#DDE5FC;color:#669">&nbsp;
                <strong><?php $this->_tag_stack[] = array('t', array('app' => 'b2c')); $this->__view_helper_model['base_view_helper']->block_t(array('app' => 'b2c'), null, $this); ob_start(); ?>弹出菜单<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_content = $this->__view_helper_model['base_view_helper']->block_t($this->_tag_stack[count($this->_tag_stack) - 1][1], $_block_content, $this); echo $_block_content; array_pop($this->_tag_stack); $_block_content=''; ?></strong></th></tr>
            <tr>
                <th><?php $this->_tag_stack[] = array('t', array('app' => 'b2c')); $this->__view_helper_model['base_view_helper']->block_t(array('app' => 'b2c'), null, $this); ob_start(); ?>三级分类最多显示数<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_content = $this->__view_helper_model['base_view_helper']->block_t($this->_tag_stack[count($this->_tag_stack) - 1][1], $_block_content, $this); echo $_block_content; array_pop($this->_tag_stack); $_block_content=''; ?>：</th>
                <td colspan="3"><?php echo $this->ui()->input(array('name' => "gshowmax",'value' => ((isset($this->_vars['setting']['gshowmax']) && ''!==$this->_vars['setting']['gshowmax'])?$this->_vars['setting']['gshowmax']:'0')));?>“0”<?php $this->_tag_stack[] = array('t', array('app' => 'b2c')); $this->__view_helper_model['base_view_helper']->block_t(array('app' => 'b2c'), null, $this); ob_start(); ?>为全显示，如果商品分类超出设置数，超出部分隐藏并显示更多<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_content = $this->__view_helper_model['base_view_helper']->block_t($this->_tag_stack[count($this->_tag_stack) - 1][1], $_block_content, $this); echo $_block_content; array_pop($this->_tag_stack); $_block_content=''; ?></td>
            </tr>
        </table>
    </div>
</div>
...
</script>";s:8:"dateline";s:10:"1440483664";s:3:"ttl";s:1:"0";}