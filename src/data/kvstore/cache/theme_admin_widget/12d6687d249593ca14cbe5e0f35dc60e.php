<?php exit(); ?>a:3:{s:5:"value";s:6111:"<?php $this->__view_helper_model['base_view_helper'] = kernel::single('base_view_helper');  echo $this->ui()->css(array('src' => "shop.css",'app' => "b2c"));?>
<p class="mall_store_info_p">
<strong>店铺：</strong>
<span>描述相符：</span> <strong><?php if( $this->_vars['data']['store_point']['0']['avg_point'] ){  echo $this->_vars['data']['store_point']['0']['avg_point'];  }else{ ?>0<?php } ?> </strong>
