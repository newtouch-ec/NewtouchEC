<?php exit(); ?>a:3:{s:5:"value";s:2757:"<div class="shop2_newp">
...
?>
			 ...
			 <div class="shop2_newp_ul_div" style="height:50px; overflow:hidden;">
                ...
                <p><span class="price le_zhi"><?php echo app::get('ectools')->model('currency')->changer_odr($this->_vars['good']['price'],$_COOKIE["S"]["CUR"],false,false,app::get('b2c')->getConf('system.money.decimals'),app::get('b2c')->getConf('system.money.operation.carryset'),app::get('b2c')->getConf('system.money.separator')); ?></span>
                         <span class="sall ri_zhi"><?php echo app::get('ectools')->model('currency')->changer_odr($this->_vars['good']['mktprice'],$_COOKIE["S"]["CUR"],false,false,app::get('b2c')->getConf('system.money.decimals'),app::get('b2c')->getConf('system.money.operation.carryset'),app::get('b2c')->getConf('system.money.separator')); ?></span>
                         <span class="cl_zhi"></span></p>
                </div>
               </li>
		    <?php } unset($this->_env_vars['foreach']["_good"]); ?>
		  </ul>
</div>";s:8:"dateline";s:10:"1439259997";s:3:"ttl";s:1:"0";}