<?php exit(); ?>a:3:{s:5:"value";s:6021:"<div class="floorthree webwidth clb" style="border-top:2px solid <?php echo $this->_vars['data']['bg_color']; ?>;"><!--需要取标题色-->
        ...
        <?php if($this->_vars['item']['goodsinfo'])foreach ((array)$this->_vars['item']['goodsinfo'] as $this->_vars['skey'] => $this->_vars['sitem']){  if( $this->_vars['skey'] < 3 ){ ?>
            <div class="floorthreead04 fl">
              <a href="<?php echo $this->_vars['sitem']['goodslink']; ?>" title="<?php echo $this->_vars['sitem']['name']; ?>">
                <?php echo $this->ui()->img(array('src' => "images/transparent.gif",'app' => "b2c",'lazyload' => kernel::single('base_view_helper')->modifier_storager(((isset($this->_vars['sitem']['image_default_id']) && ''!==$this->_vars['sitem']['image_default_id'])?$this->_vars['sitem']['image_default_id']:$this->_vars['data']['defaultImage']),'s'),'class' => "img-lazyload"));?>
        ...
        <?php if($this->_vars['item']['goodsinfo'])foreach ((array)$this->_vars['item']['goodsinfo'] as $this->_vars['ikey'] => $this->_vars['iitem']){  if( $this->_vars['ikey'] > 2 ){ ?>
            <div class="floorthreead04 fl">
              <a href="<?php echo $this->_vars['iitem']['goodslink']; ?>" title="<?php echo $this->_vars['iitem']['name']; ?>">
                <?php echo $this->ui()->img(array('src' => "images/transparent.gif",'app' => "b2c",'lazyload' => kernel::single('base_view_helper')->modifier_storager(((isset($this->_vars['iitem']['image_default_id']) && ''!==$this->_vars['iitem']['image_default_id'])?$this->_vars['iitem']['image_default_id']:$this->_vars['data']['defaultImage']),'s'),'class' => "img-lazyload"));?>
...
</script>";s:8:"dateline";s:10:"1407996190";s:3:"ttl";s:1:"0";}