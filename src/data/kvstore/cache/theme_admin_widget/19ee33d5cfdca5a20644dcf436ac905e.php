<?php exit(); ?>a:3:{s:5:"value";s:28980:"<?php $this->__view_helper_model['base_view_helper'] = kernel::single('base_view_helper'); ?><style>
            ...
            <div class="division widgetconfig">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="30%" ><?php echo $this->ui()->input(array('name' => "ad[width]",'style' => "width:50px",'value' => ((isset($this->_vars['setting']['ad']['width']) && ''!==$this->_vars['setting']['ad']['width'])?$this->_vars['setting']['ad']['width']:'546'),'required' => "true",'type' => "digits"));?></td>
                        <th width="20%" >图片高度：</th>
                        <td width="30%" ><?php echo $this->ui()->input(array('name' => "ad[height]",'style' => "width:50px",'value' => ((isset($this->_vars['setting']['ad']['height']) && ''!==$this->_vars['setting']['ad']['height'])?$this->_vars['setting']['ad']['height']:'280'),'required' => "true",'type' => "digits"));?></td>
                    </tr>
                    <tr>
    ...
    <div class="tableform">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <th>选择要展示的店铺：</th>
                <td>
                   <?php echo $this->ui()->input(array('type' => 'object','multiple' => "true",'filter' => '','rowselect' => "true",'object' => "storemanger@business",'textcol' => "store_name",'name' => "store_id",'cols' => "store_name,image",'value' => $this->_vars['setting']['store_id']));?>
                </td>
            </tr>
    ...
    <div class="tableform">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td>
                    <input type=hidden name="leftpic[0]" value="<?php echo $this->_vars['setting']['leftpic']['0']; ?>">
                    <input name='leftpic[0]' class="imgsrc x-input" value="<?php echo $this->_vars['setting']['leftpic']['0']; ?>">
                    <input type=button value="<?php $this->_tag_stack[] = array('t', array('app' => 'b2c')); $this->__view_helper_model['base_view_helper']->block_t(array('app' => 'b2c'), null, $this); ob_start(); ?>上传图片<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_content = $this->__view_helper_model['base_view_helper']->block_t($this->_tag_stack[count($this->_tag_stack) - 1][1], $_block_content, $this); echo $_block_content; array_pop($this->_tag_stack); $_block_content=''; ?>" class="uploadbtn" onclick="addPic(this);">
                </td>
                <th>链接：</th>
                <td>
                    <input name='leftlink[0]' class="x-input" value="<?php echo $this->_vars['setting']['leftlink']['0']; ?>">
                </td>
            </tr>
            <tr>
                <th>轮播左下侧图片（宽：200px 高：260px）：</th>
                <td>
                    <input type=hidden name="leftpic[1]" value="<?php echo $this->_vars['setting']['leftpic']['1']; ?>">
                    <input name='leftpic[1]' class="imgsrc x-input" value="<?php echo $this->_vars['setting']['leftpic']['1']; ?>">
                    <input type=button value="<?php $this->_tag_stack[] = array('t', array('app' => 'b2c')); $this->__view_helper_model['base_view_helper']->block_t(array('app' => 'b2c'), null, $this); ob_start(); ?>上传图片<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_content = $this->__view_helper_model['base_view_helper']->block_t($this->_tag_stack[count($this->_tag_stack) - 1][1], $_block_content, $this); echo $_block_content; array_pop($this->_tag_stack); $_block_content=''; ?>" class="uploadbtn" onclick="addPic(this);">
                </td>
                <th>链接：</th>
                <td>
                    <input name='leftlink[1]' class="x-input" value="<?php echo $this->_vars['setting']['leftlink']['1']; ?>">
                </td>
            </tr>
            <tr>
                <th>轮播下左侧图片（宽：364px 高：170px）：</th>
                <td>
                    <input type=hidden name="belowpic[0]" value="<?php echo $this->_vars['setting']['belowpic']['0']; ?>">
                    <input name='belowpic[0]' class="imgsrc x-input" value="<?php echo $this->_vars['setting']['belowpic']['0']; ?>">
                    <input type=button value="<?php $this->_tag_stack[] = array('t', array('app' => 'b2c')); $this->__view_helper_model['base_view_helper']->block_t(array('app' => 'b2c'), null, $this); ob_start(); ?>上传图片<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_content = $this->__view_helper_model['base_view_helper']->block_t($this->_tag_stack[count($this->_tag_stack) - 1][1], $_block_content, $this); echo $_block_content; array_pop($this->_tag_stack); $_block_content=''; ?>" class="uploadbtn" onclick="addPic(this);">
                </td>
                <th>链接：</th>
                <td>
                    <input name='belowlink[0]' class="x-input" value="<?php echo $this->_vars['setting']['belowlink']['0']; ?>">
                </td>
            </tr>
            <tr>
                <th>轮播下右侧图片（宽：182px 高：170px）：</th>
                <td>
                    <input type=hidden name="belowpic[1]" value="<?php echo $this->_vars['setting']['belowpic']['1']; ?>">
                    <input name='belowpic[1]' class="imgsrc x-input" value="<?php echo $this->_vars['setting']['belowpic']['1']; ?>">
                    <input type=button value="<?php $this->_tag_stack[] = array('t', array('app' => 'b2c')); $this->__view_helper_model['base_view_helper']->block_t(array('app' => 'b2c'), null, $this); ob_start(); ?>上传图片<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_content = $this->__view_helper_model['base_view_helper']->block_t($this->_tag_stack[count($this->_tag_stack) - 1][1], $_block_content, $this); echo $_block_content; array_pop($this->_tag_stack); $_block_content=''; ?>" class="uploadbtn" onclick="addPic(this);">
                </td>
                <th>链接：</th>
                <td>
                    <input name='belolink[1]' class="x-input" value="<?php echo $this->_vars['setting']['belolink']['1']; ?>">
                </td>
            </tr>
            <tr>
                <th>轮播右1(上)图片：（宽：254px 高：170px）</th>
                <td>
                    <input type=hidden name="rightpic[0]" value="<?php echo $this->_vars['setting']['rightpic']['0']; ?>">
                    <input name='rightpic[0]' class="imgsrc x-input" value="<?php echo $this->_vars['setting']['rightpic']['0']; ?>">
                    <input type=button value="<?php $this->_tag_stack[] = array('t', array('app' => 'b2c')); $this->__view_helper_model['base_view_helper']->block_t(array('app' => 'b2c'), null, $this); ob_start(); ?>上传图片<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_content = $this->__view_helper_model['base_view_helper']->block_t($this->_tag_stack[count($this->_tag_stack) - 1][1], $_block_content, $this); echo $_block_content; array_pop($this->_tag_stack); $_block_content=''; ?>" class="uploadbtn" onclick="addPic(this);">
                </td>
                <th>链接：</th>
                <td>
                    <input name='rightlink[0]' class="x-input" value="<?php echo $this->_vars['setting']['rightlink']['0']; ?>">
                </td>
            </tr>
            <tr>
                <th>轮播右1(下)图片：（宽：254px 高：280px）</th>
                <td>
                    <input type=hidden name="rightpic[1]" value="<?php echo $this->_vars['setting']['rightpic']['1']; ?>">
                    <input name='rightpic[1]' class="imgsrc x-input" value="<?php echo $this->_vars['setting']['rightpic']['1']; ?>">
                    <input type=button value="<?php $this->_tag_stack[] = array('t', array('app' => 'b2c')); $this->__view_helper_model['base_view_helper']->block_t(array('app' => 'b2c'), null, $this); ob_start(); ?>上传图片<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_content = $this->__view_helper_model['base_view_helper']->block_t($this->_tag_stack[count($this->_tag_stack) - 1][1], $_block_content, $this); echo $_block_content; array_pop($this->_tag_stack); $_block_content=''; ?>" class="uploadbtn" onclick="addPic(this);">
                </td>
                <th>链接：</th>
                <td>
                    <input name='rightlink[1]' class="x-input" value="<?php echo $this->_vars['setting']['rightlink']['1']; ?>">
                </td>
            </tr>
            <tr>
                <th>轮播右2(上)图片：（宽：200px 高：255px）</th>
                <td>
                    <input type=hidden name="rightpic[2]" value="<?php echo $this->_vars['setting']['rightpic']['2']; ?>">
                    <input name='rightpic[2]' class="imgsrc x-input" value="<?php echo $this->_vars['setting']['rightpic']['2']; ?>">
                    <input type=button value="<?php $this->_tag_stack[] = array('t', array('app' => 'b2c')); $this->__view_helper_model['base_view_helper']->block_t(array('app' => 'b2c'), null, $this); ob_start(); ?>上传图片<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_content = $this->__view_helper_model['base_view_helper']->block_t($this->_tag_stack[count($this->_tag_stack) - 1][1], $_block_content, $this); echo $_block_content; array_pop($this->_tag_stack); $_block_content=''; ?>" class="uploadbtn" onclick="addPic(this);">
                </td>
                <th>链接：</th>
                <td>
                    <input name='rightlink[2]' class="x-input" value="<?php echo $this->_vars['setting']['rightlink']['2']; ?>">
                </td>
            </tr>
            <tr>
                <th>轮播右2(下)图片：（宽：200px 高：194px）</th>
                <td>
                    <input type=hidden name="rightpic[3]" value="<?php echo $this->_vars['setting']['rightpic']['3']; ?>">
                    <input name='rightpic[3]' class="imgsrc x-input" value="<?php echo $this->_vars['setting']['rightpic']['3']; ?>">
                    <input type=button value="<?php $this->_tag_stack[] = array('t', array('app' => 'b2c')); $this->__view_helper_model['base_view_helper']->block_t(array('app' => 'b2c'), null, $this); ob_start(); ?>上传图片<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_content = $this->__view_helper_model['base_view_helper']->block_t($this->_tag_stack[count($this->_tag_stack) - 1][1], $_block_content, $this); echo $_block_content; array_pop($this->_tag_stack); $_block_content=''; ?>" class="uploadbtn" onclick="addPic(this);">
                </td>
                <th>链接：</th>
                <td>
                    <input name='rightlink[3]' class="x-input" value="<?php echo $this->_vars['setting']['rightlink']['3']; ?>">
                </td>
            </tr>
        </table>
    </div>
...
</script>";s:8:"dateline";s:10:"1417868675";s:3:"ttl";s:1:"0";}