<?php exit(); ?>a:3:{s:5:"value";s:738:"<div class="wei_top_img fl">
...
<div class="wei_top_legend fr">
    <?php if( $this->_vars['setting']['big_title'] ){ ?><h4><?php echo $this->_vars['setting']['big_title']; ?></h4><?php }  if( $this->_vars['setting']['small_title'] ){ ?><p><?php echo $this->_vars['setting']['small_title']; ?></p><?php } ?>
</div>";s:8:"dateline";s:10:"1387952418";s:3:"ttl";s:1:"0";}