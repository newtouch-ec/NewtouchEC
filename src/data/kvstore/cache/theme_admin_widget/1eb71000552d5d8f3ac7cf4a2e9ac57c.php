<?php exit(); ?>a:3:{s:5:"value";s:983:"<?php $this->__view_helper_model['base_view_helper'] = kernel::single('base_view_helper'); ?><div class="tableform widgetconfig">
<div class="division">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><?php echo $this->ui()->input(array('type' => "text",'name' => "title",'value' => ((isset($this->_vars['setting']['title']) && ''!==$this->_vars['setting']['title'])?$this->_vars['setting']['title']:'宝贝搜索')));?></td>
  </tr>
</table>
</div>
</div>";s:8:"dateline";s:10:"1407652809";s:3:"ttl";s:1:"0";}