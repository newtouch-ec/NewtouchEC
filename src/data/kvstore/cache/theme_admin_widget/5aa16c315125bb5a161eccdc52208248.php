<?php exit(); ?>a:3:{s:5:"value";s:10273:"<?php $this->__view_helper_model['base_view_helper'] = kernel::single('base_view_helper'); ?><div id="picAddress" class="tableform">
  <div class="division widgetconfig">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <th width="20%" >图片高度：</th>
        <td width="30%" ><?php echo $this->ui()->input(array('name' => "height",'style' => "width:50px",'value' => ((isset($this->_vars['setting']['height']) && ''!==$this->_vars['setting']['height'])?$this->_vars['setting']['height']:'400'),'required' => "true",'type' => "digits"));?></td>
      </tr>
      <tr>
        <th width="20%" >自动播放：</th>
        <td width="30%" >
  ...
  <div class="piccontent">
    ...
    <table  width="100%" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <th><?php $this->_tag_stack[] = array('t', array('app' => "b2c")); $this->__view_helper_model['base_view_helper']->block_t(array('app' => "b2c"), null, $this); ob_start(); ?>背景色（HexCode）：:<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_content = $this->__view_helper_model['base_view_helper']->block_t($this->_tag_stack[count($this->_tag_stack) - 1][1], $_block_content, $this); echo $_block_content; array_pop($this->_tag_stack); $_block_content=''; ?></th>
        <td>
            <input name="pic[<?php echo $this->_vars['data']['id']; ?>][hexcode]" value="<?php echo $this->_vars['data']['hexcode']; ?>" maxlength="7" />
        </td>
        <th></th>
        <td></td>
      </tr>
...
";s:8:"dateline";s:10:"1433234777";s:3:"ttl";s:1:"0";}