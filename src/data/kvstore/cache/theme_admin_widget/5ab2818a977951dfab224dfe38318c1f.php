<?php exit(); ?>a:3:{s:5:"value";s:23852:"<?php $this->__view_helper_model['base_view_helper'] = kernel::single('base_view_helper'); ?><style>
  ...
  <div class="division">
    ...
    <div class="tableform">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <th><?php $this->_tag_stack[] = array('t', array('app' => 'b2c')); $this->__view_helper_model['base_view_helper']->block_t(array('app' => 'b2c'), null, $this); ob_start(); ?>楼层数:<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_content = $this->__view_helper_model['base_view_helper']->block_t($this->_tag_stack[count($this->_tag_stack) - 1][1], $_block_content, $this); echo $_block_content; array_pop($this->_tag_stack); $_block_content=''; ?></th>
          <td>
            <input type="text" name='floor_num' value="<?php echo $this->_vars['setting']['floor_num']; ?>" class="inputstyle" >
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <th><?php $this->_tag_stack[] = array('t', array('app' => 'b2c')); $this->__view_helper_model['base_view_helper']->block_t(array('app' => 'b2c'), null, $this); ob_start(); ?>楼号背景色：<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_content = $this->__view_helper_model['base_view_helper']->block_t($this->_tag_stack[count($this->_tag_stack) - 1][1], $_block_content, $this); echo $_block_content; array_pop($this->_tag_stack); $_block_content=''; ?></th>
          <td>
            <?php echo $this->ui()->input(array('type' => "color",'name' => "fbg_color",'class' => "inputstyle",'value' => ((isset($this->_vars['setting']['fbg_color']) && ''!==$this->_vars['setting']['fbg_color'])?$this->_vars['setting']['fbg_color']:'#cccccc'),'size' => 7,'maxlength' => 7));?>
          </td>
        </tr>
        <tr>
...
</script>";s:8:"dateline";s:10:"1432801015";s:3:"ttl";s:1:"0";}