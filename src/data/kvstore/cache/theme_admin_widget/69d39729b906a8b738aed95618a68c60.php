...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><?php echo $this->ui()->input(array('type' => "text",'name' => "title",'value' => ((isset($this->_vars['setting']['title']) && ''!==$this->_vars['setting']['title'])?$this->_vars['setting']['title']:'店内客服')));?></td>
  </tr>
</table>
</div>
</div>";s:8:"dateline";s:10:"1438938779";s:3:"ttl";s:1:"0";}