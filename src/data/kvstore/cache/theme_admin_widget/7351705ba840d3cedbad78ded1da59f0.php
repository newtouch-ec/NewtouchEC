<?php exit(); ?>a:3:{s:5:"value";s:17209:"<?php $this->__view_helper_model['base_view_helper'] = kernel::single('base_view_helper'); ?><div id="picAddress" class="tableform">
  <div class="division widgetconfig">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="30%" ><?php echo $this->ui()->input(array('name' => "width",'style' => "width:50px",'value' => ((isset($this->_vars['setting']['width']) && ''!==$this->_vars['setting']['width'])?$this->_vars['setting']['width']:'700'),'required' => "true",'type' => "digits"));?></td>
        <th width="20%" >图片高度：</th>
...
";s:8:"dateline";s:10:"1407748584";s:3:"ttl";s:1:"0";}