<?php exit(); ?>a:3:{s:5:"value";s:1683:"<div class="welcome fl"><?php echo $this->_vars['setting']['welcome']; ?></div>
<div class="quick_link fl">
    <div id="loginBar_<?php echo $this->_vars['widgets_id']; ?>">
        <a href="<?php echo kernel::router()->gen_url(array('app' => b2c,'ctl' => site_passport,'act' => login)); ?>">会员登录</a>|
