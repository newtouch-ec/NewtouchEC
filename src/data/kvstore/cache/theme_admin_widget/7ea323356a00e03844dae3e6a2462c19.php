<?php exit(); ?>a:3:{s:5:"value";s:3254:"<?php $this->__view_helper_model['base_view_helper'] = kernel::single('base_view_helper'); ?><div class="tableform">
    <div class="widgetconfig">
        <table cellspacing="0" cellpadding="0" border="0" width="100%">
            <tbody id="navList">
                ...
                <tr>
                    <th>显示分享链接：</th>
                    <td><?php echo $this->ui()->input(array('required' => true,'type' => 'select','name' => "show_jiathis",'options' => array('true'=>是,'False'=>否),'value' => ((isset($this->_vars['setting']['show_jiathis']) && ''!==$this->_vars['setting']['show_jiathis'])?$this->_vars['setting']['show_jiathis']:true)));?></td>
                </tr>
                <tr>
                    <th>logo:</th>
                    <td>
...
</script>";s:8:"dateline";s:10:"1439966794";s:3:"ttl";s:1:"0";}