   ...
   <div class="ranklist">
    <a target='_blank' class="fl" href="<?php echo kernel::router()->gen_url(array('app' => b2c,'ctl' => site_product,'act' => index,'arg' => $this->_vars['good']['goods_id'])); ?>">
	  ...
	  <div class="ranklist_ri fr">
	    ...
	    <p class="price"><?php echo app::get('ectools')->model('currency')->changer_odr($this->_vars['good']['price'],$_COOKIE["S"]["CUR"],false,false,app::get('b2c')->getConf('system.money.decimals'),app::get('b2c')->getConf('system.money.operation.carryset')); ?></p>
...
";s:8:"dateline";s:10:"1407566474";s:3:"ttl";s:1:"0";}