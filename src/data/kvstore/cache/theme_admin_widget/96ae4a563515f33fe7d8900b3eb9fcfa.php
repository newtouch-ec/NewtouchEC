<?php exit(); ?>a:3:{s:5:"value";s:9034:"<a name="floor_<?php echo $this->_vars['widgets_id']; ?>" class="js_floor_icon" img_src="<?php echo $this->_vars['data']['floor_icon']; ?>"></a>
      ...
      <?php if($this->_vars['data']['wonderful'])foreach ((array)$this->_vars['data']['wonderful'] as $this->_vars['wdf_key'] => $this->_vars['wdf_item']){ ?>
        <li>
          <a href="<?php echo $this->_vars['wdf_item']['linktarget']; ?>" title="<?php echo $this->_vars['wdf_item']['linkinfo']; ?>" target="_blank">
            <img src="images/transparent.gif" lazyload="<?php echo kernel::single('base_view_helper')->modifier_storager($this->_vars['wdf_item']['link']); ?>" class="img-lazyload" />
          </a>
        </li>
      <?php } ?>
    </ul>
