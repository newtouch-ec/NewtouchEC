<?php exit(); ?>a:3:{s:5:"value";s:4866:"<?php $this->__view_helper_model['base_view_helper'] = kernel::single('base_view_helper'); ?><div class="tableform">
...
?>
                <tr>
                    ...
                    <td>
                        <button type="button" onclick="$(this).getParent('tr').remove()" > 删除</button>
                    </td>
                </tr>
...
<script>
    ...
    var PROPSTMP = '<th>标题：</th><td><input type="text" name="nav[{key}][title]" value="" class="inputstyle"></td><th>链接：</th> <td><input type="text" name="nav[{key}][link]" vtype="purl" required="true" class="inputstyle" value=""></td><td>'+btn_delete+'</td>';
...
</script>";s:8:"dateline";s:10:"1433256251";s:3:"ttl";s:1:"0";}