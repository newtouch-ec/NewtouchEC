<?php exit(); ?>a:3:{s:5:"value";s:4874:"<?php $this->__view_helper_model['base_view_helper'] = kernel::single('base_view_helper'); ?><div class="shop_head_<?php echo $this->_vars['widgets_id']; ?> shop_head" style="background:url('<?php echo $this->_vars['data']['bg_pic']; ?>') no-repeat;">
    <div class="shop_top">
...
</script>";s:8:"dateline";s:10:"1409821711";s:3:"ttl";s:1:"0";}