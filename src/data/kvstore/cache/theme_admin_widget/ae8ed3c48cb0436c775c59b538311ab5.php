<?php exit(); ?>a:3:{s:5:"value";s:1348:"<div id="other_menu_header_<?php echo $this->_vars['widgets_id']; ?>">
    <a href="<?php echo $this->_vars['data']['title_link']; ?>" id='other_menu_a_<?php echo $this->_vars['widgets_id']; ?>'>
        <em class="fl"><?php echo $this->_vars['data']['title']; ?></em><i class="fl"></i>
    </a>
    <div class="clb tool_menu_list" id='other_menu_link_<?php echo $this->_vars['widgets_id']; ?>' style="display:none;">
