<?php exit(); ?>a:3:{s:5:"value";s:3013:"<div id="goods_exshow_config" class="tableform">
    <div class="division">
        <label>
            版块标题：
            <input type="text" class="x-input" name="block_name" value="<?php echo $this->_vars['setting']['block_name']; ?>"/>
        </label>
    </div>
    <div class="division">
        <label>
...
";s:8:"dateline";s:10:"1438937587";s:3:"ttl";s:1:"0";}