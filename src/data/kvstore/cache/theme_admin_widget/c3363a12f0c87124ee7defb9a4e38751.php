<?php exit(); ?>a:3:{s:5:"value";s:3443:"<?php $this->__view_helper_model['base_view_helper'] = kernel::single('base_view_helper'); ?><div class="cart_div" id="head_menu_cart">
    <a href="<?php echo kernel::router()->gen_url(array('app' => b2c,'ctl' => site_cart,'act' => index)); ?>" class="mini-cart fl jiesuan2">
   <b></b>
   我的购物车 
    <?php if( $this->_vars['setting']['cart_show_type']==1 ){  $this->_tag_stack[] = array('t', array('app' => 'b2c')); $this->__view_helper_model['base_view_helper']->block_t(array('app' => 'b2c'), null, $this); ob_start();  $_block_content = ob_get_contents(); ob_end_clean(); $_block_content = $this->__view_helper_model['base_view_helper']->block_t($this->_tag_stack[count($this->_tag_stack) - 1][1], $_block_content, $this); echo $_block_content; array_pop($this->_tag_stack); $_block_content='';  }else{  $this->_tag_stack[] = array('t', array('app' => 'b2c')); $this->__view_helper_model['base_view_helper']->block_t(array('app' => 'b2c'), null, $this); ob_start();  $_block_content = ob_get_contents(); ob_end_clean(); $_block_content = $this->__view_helper_model['base_view_helper']->block_t($this->_tag_stack[count($this->_tag_stack) - 1][1], $_block_content, $this); echo $_block_content; array_pop($this->_tag_stack); $_block_content='';  } ?>
	
  </a>
  <a href="<?php echo kernel::router()->gen_url(array('app' => b2c,'ctl' => site_cart,'act' => index)); ?>" class="jiesuan">
     <script>
        var _prefix_number = "";
