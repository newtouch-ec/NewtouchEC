<?php exit(); ?>a:3:{s:5:"value";s:5372:"<ul class="clb js_menu_<?php echo $this->_vars['widgets_id']; ?>">
 ...
 if( $this->_vars['setting']['max_leng'] && $this->_vars['key']>=$this->_vars['setting']['max_leng'] ){  if( $this->_vars['key']==$this->_vars['setting']['max_leng'] ){ ?>
        <li class="js_menu_1" id="index_menu_more_<?php echo $this->_vars['widgets_id']; ?>">
            ...
            <div style="display:none;" id="index_menu_more_view_<?php echo $this->_vars['widgets_id']; ?>" class="inav_more f16">
              <ul>
...
";s:8:"dateline";s:10:"1387952417";s:3:"ttl";s:1:"0";}