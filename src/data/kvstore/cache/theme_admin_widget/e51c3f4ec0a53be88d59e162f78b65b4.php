<?php exit(); ?>a:3:{s:5:"value";s:2039:"<h4><?php echo $this->_vars['data']['title']; ?></h4>
<ul class="new_shop">
...
<a href="<?php echo kernel::router()->gen_url(array('app' => business,'ctl' => "site_shop",'act' => "gallery",'arg0' => $this->_vars['data']['store']['store_id'])); ?>"><input type="button" class="shop_right_button ri_zhi" value="更多宝贝" /></a>
<div class="cl_zhi"></div>";s:8:"dateline";s:10:"1432608395";s:3:"ttl";s:1:"0";}