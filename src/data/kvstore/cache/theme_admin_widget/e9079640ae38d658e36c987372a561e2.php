<?php exit(); ?>a:3:{s:5:"value";s:1799:"<div class="prolist_hot dis_bl clb">
...
?>
    ...
    <span class="span_<?php echo $this->_env_vars['foreach']['product']['iteration']%7; ?>"><?php echo kernel::single('base_view_helper')->modifier_cut($this->_vars['linklist']['nice'],40); ?></span>
    </a>
		 </li>
     <?php } unset($this->_env_vars['foreach'][product]); ?>
	   </ul>
</div>";s:8:"dateline";s:10:"1430981901";s:3:"ttl";s:1:"0";}