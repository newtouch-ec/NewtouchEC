<?php exit(); ?>a:3:{s:5:"value";s:4834:"<form action="<?php echo kernel::router()->gen_url(array('app' => b2c,'ctl' => site_search,'act' => result)); ?>"  class="SearchBar  searchBar_<?php echo $this->_vars['widgets_id']; ?>" >
...
<!-- <?php if( $this->_vars['data']['bottom_html'] ){  echo kernel::single('base_view_helper')->modifier_regex_replace($this->_vars['data']['bottom_html'],'/widgets_id/',$this->_vars['widgets_id']);  } ?> -->";s:8:"dateline";s:10:"1387952416";s:3:"ttl";s:1:"0";}