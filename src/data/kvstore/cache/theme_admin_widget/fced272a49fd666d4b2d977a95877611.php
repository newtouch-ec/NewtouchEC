<?php exit(); ?>a:3:{s:5:"value";s:15505:"<?php $this->__view_helper_model['base_view_helper'] = kernel::single('base_view_helper');  if( $this->_vars['data']['top_html'] ){  echo $this->_vars['data']['top_html'];  } ?>
