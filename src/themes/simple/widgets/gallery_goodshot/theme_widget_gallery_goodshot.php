...
function theme_widget_gallery_goodshot(&$setting,&$smarty) {
    ...
    $sql='select goods_id ,goods_id as id,name as nice,image_default_id  as pic,price,udfimg ,thumbnail_pic from sdb_b2c_goods where '.$filter['str_where'].' order by buy_count desc limit 0,'.$show_nums;
